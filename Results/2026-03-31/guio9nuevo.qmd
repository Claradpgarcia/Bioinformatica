...
Si en nseq te informa del núemro de sencuencias disponibles. En este caso es 42.

¿Qué longitud tiene el alineamiento? 
Si, en nchar (número de carácteres, es decir la longitud). 16603
...
Comprobamos si está enraizado el árbol:
> is.rooted(mt_nj)
[1] FALSE
...
- La datación puede ser no muy precisa
- Las secuecnias pueden tener cambios de nucleotidos que se deban a cambios en la muestra como desaminaciones, entonces en realidad no hay cambio aunque si que se detecte uno.
...
- humano - chimpancé: 0.09104153
- humano - neanderntal: 0.01214282  
7,5 veces mayor.
...
```
Tras observar el heatmap sabemos que hay 4 secuencias iguales entre ellas y las otras 3 tambien son iguales. Por lo que nos quedamos para el resto del estudio solo dos secuencias una de cada grupo.
