...
```
:::
El [[1]] indica que tienen que extraer el primer elemento de la lista. Si introduces str + set (por ejemplo) te dice lo que tienes dentro. Es una lista de lo que tiene y si la lista es [1,2,3,4] y pones el [[1]] solo te dará lo que hay dentro del elemento 1 de la lista original. Si pones [[4]] te dará lo que hay en el elemento 4.
...
Si se resta los valores de la 2 URL con los de la 1º URL te da la cantida dde proteinas que no tienen un dominio asignado.
...
1291419 --> taxones con proteínas
2678841 --> taxones
2678841-1291419 = 1387422 son taxones sin proteínas

Entre las proteínas no revisadas han dejado de añadir la de los taxones muy parecidos a otros que ya tienen las secuencias en las bases de datos.

- https://www.ebi.ac.uk/interpro/api/protein
- https://www.ebi.ac.uk/interpro/api/protein/structure

"pdb": 228088
proteinas totales: 202150435

(228088/202150435)x100 = 0,11% de proteínas con estructura terciaria.
...
```{r}
taxon8493 <- fromJSON(paste0(API, 'protein/entry/pfam/PF01530/taxonomy/uniprot/8493'))
